...
class MarketDataRequest:
    ...
    async def get_interest_rate(self, symbol, startAt=None, endAt=None, reverse=True, offset=0, forward=True, maxCount=10):
        """
        ...
        return await self._request('GET', '/api/v1/interest/query', auth=False, params=params)

    async def get_index_list(self, symbol, startAt=None, endAt=None, reverse=True, offset=0, forward=True, maxCount=10):
        """
        ...
        return await self._request('GET', '/api/v1/index/query', auth=False, params=params)

    async def get_current_mark_price(self, symbol):
        """
        ...
        return await self._request('GET', '/api/v1/mark-price/{symbol}/current'.format(symbol=symbol), auth=False)

    async def get_premium_index(self, symbol, startAt=None, endAt=None, reverse=True, offset=0, forward=True, maxCount=10):
        """
        ...
        return await self._request('GET', '/api/v1/premium/query', auth=False, params=params)

    async def get_current_fund_rate(self, symbol):
        """
        ...
        return await self._request('GET', '/api/v1/funding-rate/{symbol}/current'.format(symbol=symbol), auth=False)
    ...
    async def get_trade_history(self, symbol):
        ...
        return await self._request('GET', '/api/v1/trade/history', auth=False, params=params)

    async def l2_order_book(self, symbol):
        """
        ...
        return await self._request('GET', '/api/v1/level2/snapshot', auth=False, params=params)

    async def get_l2_messages(self, symbol, start, end):
        """
        ...
        return await self._request('GET', '/api/v1/level2/message/query', auth=False, params=params)

    async def l3_order_book(self, symbol):
        """
        ...
        return await self._request('GET', '/api/v1/level3/snapshot', auth=False, params=params)

    async def get_l3_messages(self, symbol, start, end):
        """
        ...
        return await self._request('GET', '/api/v1/level3/message/query', auth=False, params=params)
    ...
    async def get_ticker(self, symbol):
        ...
        return await self._request('GET', '/api/v1/ticker', auth=False, params=params)
    ...
    async def get_contracts_list(self):
        ...
        """
        return await self._request('GET', '/api/v1/contracts/active', auth=False)
    ...
    async def get_kline_data(self, symbol, granularity:int, begin_t=None, end_t=None):
        """
        ...
        return await self._request('GET', '/api/v1/kline/query', auth=False, params=params)
